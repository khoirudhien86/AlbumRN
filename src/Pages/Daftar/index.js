...
const Daftar = () => {
    const [value, setDaftarEmail] = useState();
    const [pasword, setDaftarPassword] = useState();
    return (
        <View>
            ...
            <TextInput 
                ...
                onChangeText={text => setDaftarEmail(text)}
                value={value}
            ...
            <TextInput 
                style={{borderWidth: 1, borderColor: 'gray', margin: 20, height: 50, backgroundColor: 'gray', borderRadius: 20, color: 'white', paddingHorizontal: 20}}
                onChangeText={text => setDaftarPassword(text)}
                value={pasword}
                placeholder="masukkan password anda"
                placeholderTextColor="red"
            />
            <View style={{alignItems: 'center'}}>
                <TouchableOpacity style={{borderColor: 'red', borderWidth: 1, marginTop: 10, borderRadius: 15, backgroundColor: '#E64A19', width: 150}}>
